...
class Marvel(BaseService[Series, Comic]):
    ...
    def _process_metadata(
        self: Marvel, metadata: Metadata | None, series: Series, issue: Comic
    ) -> Metadata | None:
        pass

    def _process_metron_info(
        self: Marvel, metron_info: MetronInfo | None, series: Series, issue: Comic
    ) -> MetronInfo | None:
        pass

    def _process_comic_info(
        self: Marvel, comic_info: ComicInfo | None, series: Series, issue: Comic
    ) -> ComicInfo | None:
        pass
